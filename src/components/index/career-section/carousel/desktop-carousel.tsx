    ...
    return (
        <div className="-ms-6 -mt-2 flex gap-10">
            ...
            <div className="relative -my-10 w-full overflow-hidden">
                <div className="pointer-events-none absolute left-0 top-0 z-10 h-5 w-full bg-gradient-to-b from-light to-transparent dark:from-dark" />
                <div className="pointer-events-none absolute bottom-0 left-0 z-10 h-5 w-full bg-gradient-to-t from-light to-transparent dark:from-dark" />
...
const PreviewCard = ({ index, onCardHover, from, to, title, active, company, companyUrl }) => (
    <div
        className={`
             border-l-2 border-secondary bg-white px-5 pb-3 pt-5 transition-opacity dark:bg-dark 
            ${active ? 'dark:bg-gradient-to-r dark:from-secondary/20 dark:to-darkCard/50 dark:to-50%' : 'opacity-60'} 
